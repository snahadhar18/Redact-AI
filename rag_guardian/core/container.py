...
from rag_guardian.core.detector import DetectorProtocol, NullDetector
from rag_guardian.core.redaction import Redactor
...
class Container:
    ...
    def ingestion_factory(self):  # type: ignore[no-untyped-def]
        ...
        from rag_guardian.ingestion.factory import SourceFactory
