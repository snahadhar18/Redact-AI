...
* through Python entry points in the ``rag_guardian.detectors`` group, which
...
from rag_guardian.core.detector import DetectorProtocol
...
ENTRY_POINT_GROUP = "rag_guardian.detectors"
