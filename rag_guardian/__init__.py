"""RAG Guardian -- enterprise-grade AI security gateway infrastructure.
...
plugins integrated through the :class:`rag_guardian.core.detector.Detector`
contract and the :class:`rag_guardian.core.registry.DetectorRegistry`.
